...
public class StringUtils {
     ...
     * replacement using the {@link java.util.regex.Pattern#DOTALL} option. DOTALL is also know as single-line mode in Perl. This call
     ...
     * @since 3.1
     * @deprecated use {@link StringUtils#toEncodedString(byte[], java.nio.charset.Charset)} instead of String constants in your code
     */
    @Deprecated
     ...
     * @since 3.3 No longer throws {@link java.io.UnsupportedEncodingException}.
     */
