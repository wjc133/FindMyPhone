...
import com.elite.findmyphone.httpvisitor.exception.NetworkError;
import com.elite.findmyphone.httpvisitor.exception.ServerError;
...
public class NormalNetWorker implements NetWorker {
    ...
    public NetworkResponse performRequest(Request<?> request) throws HttpVisitorError {
        ...
        try {
            ...
            return new NetworkResponse(statusCode, data, responseHeaders, false, SystemClock.elapsedRealtime() - startTime);
            ...
            if (data != null && statusCode > 500) {
                NetworkResponse networkResponse = new NetworkResponse(statusCode, data,
                        responseHeaders, false, SystemClock.elapsedRealtime() - startTime);
